...
class PowerPoint():
    def __init__(self, pptx_path: Union[str, os.PathLike], output_dir: Union[str, os.PathLike]) -> None:
        self.path: Union[str, os.PathLike] = pptx_path
        ...
        if platform.system() == "Windows":
            ...
            raise EnvironmentError("Unsupported operating system for PowerPoint processing.")
        ...
        assert len(self.slide_image_paths) == len(self.slide_notes), "Number of slide images and notes do not match."
